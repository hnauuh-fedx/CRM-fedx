...
const permissionCodeOptions = [
  ...
  { code: "report.admission.view", name: "Xem báo cáo Tuyển sinh theo phạm vi", module: "report" },
  { code: "report.student.view", name: "Xem báo cáo Sinh viên theo phạm vi", module: "report" },
