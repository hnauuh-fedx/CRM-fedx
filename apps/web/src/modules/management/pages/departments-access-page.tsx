      ...
      <Card className="gap-4 border-border/70 py-5 shadow-xs">
        ...
        <CardContent className="px-5">
          ...
          >
            ...
            <AutoFilterActions snapshot={filters} onApply={() => { setAppliedFilters({ search: filters.search.trim() }); setPage(1); }} onReset={() => { setFilters(emptyFilters); setAppliedFilters(emptyFilters); setPage(1); }} />
          </form>
        </CardContent>
      </Card>
