  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-6">
      <PageHeader
        eyebrow="CRM Sale"
        title="KPI đội nhóm"
        scopeLabel="Theo phòng ban / Quyền truy cập"
        description="Theo dõi hiệu suất làm việc, tỷ lệ chuyển đổi và hoạt động của từng nhân viên Telesale."
      />
      <ReportFilters
      ...
      {reportQuery.isLoading ? (
        ...
        <Card className="mx-auto w-full max-w-xl">
          <ErrorState title="Không thể tải KPI đội nhóm" description="Vui lòng thử lại để cập nhật số liệu." onReload={() => reportQuery.refetch()} />
        </Card>
      ) : (
        <>
  ...
  return (
    <Card className="gap-0 overflow-hidden border-border/70 py-0 shadow-xs">
      <CardHeader className="border-b py-5">
        <CardTitle>Hiệu quả làm việc đội ngũ</CardTitle>
      </CardHeader>
...
function ReportSkeleton() {
  return (
    <output className="flex flex-col gap-6" aria-label="Đang tải KPI đội nhóm">
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
