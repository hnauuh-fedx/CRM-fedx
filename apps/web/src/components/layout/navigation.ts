    ...
    items: [
      {
        ...
        children: [
          ...
          {
            label: "Check trùng data",
            href: "/marketing/check-trung-data",
            icon: ScanSearch,
            permissions: ["lead.view_all", "lead.view_department", "lead.view_assigned"],
          },
        ],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Megaphone,
        permissions: ["report.view_all", "report.marketing.view", "report.marketing.view_own"],
      },
      {
        label: "Sale chi tiết",
        href: "/bao-cao/sale",
      ...
      },
      {
        ...
        icon: ClipboardList,
        permissions: ["report.view_all", "report.admission.view", "admission.view_all", "admission.view"],
      },
      {
        label: "Sinh viên chi tiết",
        href: "/bao-cao/sinh-vien",
        icon: GraduationCap,
        permissions: ["report.view_all", "report.student.view", "student.view_all", "student.view"],
      },
    ],
  },
  {
