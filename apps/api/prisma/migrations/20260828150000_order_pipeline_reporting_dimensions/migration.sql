...
COMMENT ON VIEW "reporting"."sale_pipeline_scope_fact" IS
  'Safe scoped Sale dataset. Pipeline stage position is non-sensitive and preserves configured pipeline order; has_application means the lead is currently at pipeline stage L3.';
